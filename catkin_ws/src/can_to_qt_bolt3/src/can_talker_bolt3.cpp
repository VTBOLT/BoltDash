...
int main(int argc, char **argv)
{
	...
	while (ros::ok())
	{
		...
		case 0xA1:
		{
			...
			can_msg.can_data = data;
			//can_data.define = TEMP_CONTORL_BOARD;
			topic_can_msg.publish(can_msg);
			ROS_INFO("name: %s, can_id [%i], data: %i", can_msg.name, can_msg.can_id, can_msg.can_data);
			break;
		}
		...
		case 0xA5:
		{
			...
			can_msg.can_data = data;
			//can_data.define = RESOLVER_ANGLE;
			topic_can_msg.publish(can_msg);
			ROS_INFO("name: %s, can_id [%i], data: %i", can_msg.name, can_msg.can_id, can_msg.can_data);
			break;
		}
		case 0xA6:
		{
			...
			can_msg.can_data = data;
			//can_data.define = DC_BUS_CURRENT;
			topic_can_msg.publish(can_msg);
			ROS_INFO("name: %s, can_id [%i], data: %i", can_msg.name, can_msg.can_id, can_msg.can_data);
			break;
		}
		case 0xA7:
		{
			...
			can_msg.can_data = data;
			//can_data.define = DC_BUS_VOLTAGE;
			topic_can_msg.publish(can_msg);
			ROS_INFO("name: %s, can_id [%i], data: %i", can_msg.name, can_msg.can_id, can_msg.can_data);
			data = (message.data[3] << 8 | message.data[2]);
			can_msg.name = "OUTPUT_VOLTAGE";
			can_msg.can_data = data;
			//can_data.define = OUTPUT_VOLTAGE;
			topic_can_msg.publish(can_msg);
			ROS_INFO("name: %s, can_id [%i], data: %i", can_msg.name, can_msg.can_id, can_msg.can_data);
			data = (message.data[5] << 8 | message.data[4]);
			can_msg.name = "PHASE_AB_VOLTAGE";
			can_msg.can_data = data;
			//can_data.define = PHASE_AB_VOLTAGE;
			topic_can_msg.publish(can_msg);
			ROS_INFO("name: %s, can_id [%i], data: %i", can_msg.name, can_msg.can_id, can_msg.can_data);
			data = (message.data[7] << 8 | message.data[6]);
			can_msg.name = "PHASE_BC_VOLTAGE";
			can_msg.can_data = data;
			//can_data.define = PHASE_BC_VOLTAGE;
			topic_can_msg.publish(can_msg);
			ROS_INFO("name: %s, can_id [%i], data: %i", can_msg.name, can_msg.can_id, can_msg.can_data);
		...
		case 0xA8:
		{
			...
			can_msg.can_data = data;
			//can_data.define = ID_FEEDBACK;
			topic_can_msg.publish(can_msg);
			ROS_INFO("name: %s, can_id [%i], data: %i", can_msg.name, can_msg.can_id, can_msg.can_data);
			data = (message.data[7] << 8 | message.data[6]);
			can_msg.name = "IQ_FEEDBACK";
			can_msg.can_data = data;
			//can_data.define = IQ_FEEDBACK;
			topic_can_msg.publish(can_msg);
			ROS_INFO("name: %s, can_id [%i], data: %i", can_msg.name, can_msg.can_id, can_msg.can_data);
			break;
		}
		case 0xAA:
		{
			...
			can_msg.can_data = data;
			//can_data.define = VSM_STATE;
			topic_can_msg.publish(can_msg);
			ROS_INFO("name: %s, can_id [%i], data: %i", can_msg.name, can_msg.can_id, can_msg.can_data);
			data = (message.data[2]);
			can_msg.name = "INVERTER_STATE";
			can_msg.can_data = data;
			//can_data.define = INVERTER_STATE;
			topic_can_msg.publish(can_msg);
			ROS_INFO("name: %s, can_id [%i], data: %i", can_msg.name, can_msg.can_id, can_msg.can_data);
			break;
		}
		...
		case 0xAC:
		{
			...
			can_msg.can_data = data;
			//can_data.define = COMMAND_TORQUE;
			topic_can_msg.publish(can_msg);
			ROS_INFO("name: %s, can_id [%i], data: %i", can_msg.name, can_msg.can_id, can_msg.can_data);
			data = (message.data[3] << 8 | message.data[2]);
		...
		case 0x03B:
		{
			...
			can_msg.can_data = data;
			//can_data.define = PACK_CURRENT;
			topic_can_msg.publish(can_msg);
			ROS_INFO("name: %s, can_id [%i], data: %i", can_msg.name, can_msg.can_id, can_msg.can_data);
			data = (message.data[2]);
			can_msg.name = "PACK_INST_VOLTAGE";
			can_msg.can_data = data;
			//can_data.define = PACK_INST_VOLTAGE;
			topic_can_msg.publish(can_msg);
			ROS_INFO("name: %s, can_id [%i], data: %i", can_msg.name, can_msg.can_id, can_msg.can_data);
			break;
		}
		case 0x3CB:
		{
			...
			can_msg.can_data = data;
			//can_data.define = PACK_TEMP_HIGH;
			topic_can_msg.publish(can_msg);
			ROS_INFO("name: %s, can_id [%i], data: %i", can_msg.name, can_msg.can_id, can_msg.can_data);
			data = (message.data[5]);
			can_msg.name = "PACK_TEMP_LOW";
			can_msg.can_data = data;
			//can_data.define = PACK_TEMP_LOW;
			topic_can_msg.publish(can_msg);
			ROS_INFO("name: %s, can_id [%i], data: %i", can_msg.name, can_msg.can_id, can_msg.can_data);
			break;
		}
