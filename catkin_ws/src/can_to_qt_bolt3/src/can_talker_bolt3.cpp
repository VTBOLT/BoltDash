...
int main(int argc, char **argv)
{
  ...
  ros::Publisher chatter_motor = n.advertise<can_to_qt_bolt3::motor_msg>("chatter_motor", 1000);
  ros::Publisher chatter_batterytemp = n.advertise<can_to_qt_bolt3::batterytemp_msg>("chatter_batterytemp", 1000);
  ros::Publisher chatter_temp = n.advertise<can_to_qt_bolt3::temp_msg>("chatter_temp", 1000);
  ros::Publisher chatter_current = n.advertise<can_to_qt_bolt3::current_msg>("chatter_current", 1000);
  ros::Publisher chatter_emcy6 = n.advertise<can_to_qt_bolt3::emcy6_msg>("chatter_emcy6", 1000);
  ros::Publisher chatter_emcy7 = n.advertise<can_to_qt_bolt3::emcy7_msg>("chatter_emcy7", 1000);
  ros::Publisher chatter_drive7 = n.advertise<can_to_qt_bolt3::drive7_msg>("chatter_drive7", 1000);
  ...
  while (ros::ok())
    {
      ...
      can_to_qt_bolt3::motor_msg motor_msg;
      can_to_qt_bolt3::batterytemp_msg batterytemp_msg;
      can_to_qt_bolt3::temp_msg temp_msg;
      can_to_qt_bolt3::current_msg current_msg;
      can_to_qt_bolt3::emcy6_msg emcy6_msg;
      can_to_qt_bolt3::emcy7_msg emcy7_msg;
      can_to_qt_bolt3::drive7_msg drive7_msg;
